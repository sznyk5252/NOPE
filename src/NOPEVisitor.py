...
class NOPEVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by NOPEParser#throws_macro.
    def visitThrows_macro(self, ctx:NOPEParser.Throws_macroContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by NOPEParser#header_macro.
    def visitHeader_macro(self, ctx:NOPEParser.Header_macroContext):
        return self.visitChildren(ctx)
