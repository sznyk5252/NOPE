...
public class NOPELexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "T__13", "COM", "EXPL_SPACE", "EXPL_ENDL", 
			"SPACE", "ENDL", "SEP", "LP", "RP", "LBRACE", "RBRACE", "LIDXBR", "RIDXBR", 
			"NUMB", "ESCCHAR", "ASSIGN", "AND", "OR", "QUOTE", "EQ", "NEQ", "LS", 
			"GR", "LSEQ", "GREQ", "NEGATION", "MUL", "DIV", "ADD", "SUB", "RETURN", 
